...
namespace XF.ChartLibrary.Renderer
{
    partial class YAxisRenderer
    {
        ...
        public SKRect GetGridClippingRect()
        {
            ...
            rect.Offset(0.0f, -Axis.GridLineWidth);
            return rect;
        }
        ...
        protected SKPoint[] GetTransformedPositions()
        {
            ...
            {
                TransformedPositionsBuffer = new SKPoint[mYAxis.entryCount * 2];
            }
        ...
        protected void DrawZeroLine(SKCanvas c)
        {
            ...
            int clipRestoreCount = c.Save();
            var rect = ViewPortHandler.ContentRect;
            rect.Offset(0.0f, -mYAxis.ZeroLineWidth);
            c.ClipRect(rect);
        ...
        public void RenderLimitLines(SKCanvas c)
        {
            ...
            foreach (LimitLine l in limitLines)
            {
                ...
                int clipRestoreCount = c.Save();
                var mLimitLineClippingRect = ViewPortHandler.ContentRect;
                mLimitLineClippingRect.Offset(0.0f, -l.LineWidth);
