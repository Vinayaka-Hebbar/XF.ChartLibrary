...
namespace XF.ChartLibrary.Components
{
    public partial  class Legend
    {
        ...
        /// the Legend.
        public void CalculateDimensions(UIKit.UIFont font, ViewPortHandler viewPortHandler)
        {
            var maxEntrySize = GetMaximumEntrySize(font);
                ...
                case Orientation.Vertical:
                    {
                        ...
                        float labelLineHeight = (float)font.LineHeight;
                        ...
                        for (int i = 0; i < entryCount; i++)
                        {
                            ...
                            if (label != null)
                            {
                                var size = font.MeasureWidth(label);
                ...
                case Orientation.Horizontal:
                    {
                        ...
                        float labelLineHeight = (float)font.LineHeight;
                        float labelLineSpacing = yEntrySpace;
                        ...
                        for (int i = 0; i < entryCount; i++)
                        {
                            ...
                            if (label != null)
                            {
                                ...
                                CalculatedLabelSizes.Add(font.Measure(label));
